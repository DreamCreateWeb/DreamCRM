...
| Business | Shop | `/shop` | Premium. Already the workspace pattern: hub w/ 5 doorway cards (Orders · Memberships · Coupons · **Collections** — the AR workboard, added 2026-07-12 — · Payments) + Stripe Connect status + catalog + loyalty. Storefront + checkout, orders/fulfillment, payments reconciliation, memberships (subscription checkout; powers the site's /dental-plans page), coupons + birthday codes, low-stock nudge, CSV exports. |
