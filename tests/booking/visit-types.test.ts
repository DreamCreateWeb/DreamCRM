...
describe('visitTypeDuration', () => {
  it('returns the catalog duration for a known id', () => {
    const stored: VisitType[] = [
      { id: 'root_canal', label: 'Root canal', durationMinutes: 90, bookablePublic: false, bookablePortal: false, depositCents: 0, prepInstructions: '' },
    ]
...
describe('publicVisitTypes / portalVisitTypes', () => {
  it('publicVisitTypes filters to bookablePublic', () => {
    const stored: VisitType[] = [
      { id: 'a', label: 'A', durationMinutes: 30, bookablePublic: true, bookablePortal: false, depositCents: 0, prepInstructions: '' },
      { id: 'b', label: 'B', durationMinutes: 30, bookablePublic: false, bookablePortal: true, depositCents: 0, prepInstructions: '' },
    ]
