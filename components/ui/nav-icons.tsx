...
const icons: Record<string, (p: IconProps) => React.ReactElement> = {
  ...
  moon:     (p) => <Icon className={p.className}><path d="M12.34 2.02a9.98 9.98 0 00-1.6 5.48c0 5.52 4.48 10 10 10 .34 0 .68-.02 1.02-.05A9.99 9.99 0 0112 22C6.48 22 2 17.52 2 12c0-5.17 3.92-9.42 8.96-9.95l1.38-.03z" /></Icon>,
