      ...
      <div className="mx-auto max-w-lg v2-panel p-6 sm:p-8 text-center">
        ...
        {!canManageBilling ? (
          ...
          <form action={startActivationCheckout} className="mt-6">
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-teal-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-teal-700 dark:bg-teal-400 dark:text-gray-900 dark:hover:bg-teal-300"
            >
              Set up billing →
            </button>
          </form>
