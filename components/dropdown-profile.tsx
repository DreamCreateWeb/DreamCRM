    ...
    <Menu as="div" className="relative inline-flex">
      ...
      >
        ...
        <MenuItems as="ul" className="focus:outline-hidden">
          <MenuItem as="li">
            <Link className="font-medium text-sm flex items-center py-1 px-3 text-violet-500 hover:text-violet-600" href="/settings/account">
              Settings
            </Link>
          </MenuItem>
          <MenuItem as="li">
            <button
              ...
              className="font-medium text-sm flex items-center py-1 px-3 w-full text-left text-violet-500 hover:text-violet-600"
            >
              Sign Out
            </button>
          </MenuItem>
