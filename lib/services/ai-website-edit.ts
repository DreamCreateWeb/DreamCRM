...
const BASE_COPY_KEYS: CopyKey[] = [
  ...
  // ── New patients page ──────────────────────────────────────────────────────
  { key: 'newPatients.heroEyebrow', label: 'New-patients page hero eyebrow', fallback: '', page: '/new-patients' },
  { key: 'newPatients.heading', label: 'New-patients page hero headline', fallback: '', page: '/new-patients' },
  { key: 'newPatients.heroIntro', label: 'New-patients page hero intro', fallback: '', page: '/new-patients' },
  { key: 'newPatients.expect.eyebrow', label: 'New-patients "what to expect" eyebrow', fallback: '', page: '/new-patients' },
  { key: 'newPatients.expect.heading', label: 'New-patients "what to expect" headline', fallback: 'Your first visit, step by step.', page: '/new-patients' },
  { key: 'newPatients.expect.*.title', label: 'New-patients first-visit step title', fallback: '', page: '/new-patients' },
  { key: 'newPatients.expect.*.body', label: 'New-patients first-visit step body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.bringEyebrow', label: 'New-patients "what to bring" eyebrow', fallback: '', page: '/new-patients' },
  { key: 'newPatients.bringHeading', label: 'New-patients "what to bring" headline', fallback: 'What to bring', page: '/new-patients' },
  { key: 'newPatients.bringIntro', label: 'New-patients "what to bring" intro', fallback: '', page: '/new-patients' },
  { key: 'newPatients.bring.*.title', label: 'New-patients bring-checklist item title', fallback: '', page: '/new-patients' },
  { key: 'newPatients.bring.*.body', label: 'New-patients bring-checklist item body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.intakeHeading', label: 'New-patients online-intake card title', fallback: 'Skip the clipboard', page: '/new-patients' },
  { key: 'newPatients.intakeBody', label: 'New-patients online-intake card body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.moneyEyebrow', label: 'New-patients money-section eyebrow', fallback: '', page: '/new-patients' },
  { key: 'newPatients.moneyHeading', label: 'New-patients money-section headline', fallback: 'Costs, insurance, and zero surprises.', page: '/new-patients' },
  { key: 'newPatients.moneyInsuranceTitle', label: 'New-patients insurance card title', fallback: 'Using insurance?', page: '/new-patients' },
  { key: 'newPatients.moneyInsuranceBody', label: 'New-patients insurance card body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.moneyPaymentTitle', label: 'New-patients payment card title', fallback: 'Paying without insurance?', page: '/new-patients' },
  { key: 'newPatients.moneyPaymentBody', label: 'New-patients payment card body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.plansTitle', label: 'New-patients dental-plan card title', fallback: 'No dental insurance?', page: '/new-patients' },
  { key: 'newPatients.plansBody', label: 'New-patients dental-plan card body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.comfortEyebrow', label: 'New-patients "no judgment" eyebrow', fallback: '', page: '/new-patients' },
  { key: 'newPatients.comfortHeading', label: 'New-patients "no judgment" headline', fallback: 'No judgment, ever.', page: '/new-patients' },
  { key: 'newPatients.comfortBody', label: 'New-patients "no judgment" body', fallback: '', page: '/new-patients' },
  { key: 'newPatients.faqHeading', label: 'New-patients FAQ section heading', fallback: '', page: '/new-patients' },
  { key: 'newPatients.cta.heading', label: 'New-patients closing CTA headline', fallback: 'Ready when you are.', page: '/new-patients' },
  { key: 'newPatients.cta.subhead', label: 'New-patients closing CTA subhead', fallback: '', page: '/new-patients' },
  // ── Dental plans page ──────────────────────────────────────────────────────
