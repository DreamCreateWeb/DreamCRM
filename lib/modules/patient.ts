...
export const patientModules: ModuleRegistry = {
  ...
  modules: [
    ...
    { id: 'records',        path: '/patient/records',       label: 'My Records',      section: 'Pages',    icon: 'folder',  status: 'live' },
    { id: 'intake',         path: '/patient/intake',        label: 'Intake Form',     section: 'Pages',    icon: 'doc',     status: 'live' },
