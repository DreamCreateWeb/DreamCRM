...
export const patientModules: ModuleRegistry = {
  tenantType: 'patient',
  modules: [
    { id: 'home',           path: '/dashboard',     label: 'Home',           section: 'Pages', icon: 'home',    status: 'live' },
    { id: 'appointments',   path: '/appointments',  label: 'My Appointments',section: 'Pages', icon: 'cal',     status: 'live' },
    { id: 'book',           path: '/book',          label: 'Book Visit',     section: 'Pages', icon: 'plus',    status: 'live' },
    { id: 'records',        path: '/records',       label: 'My Records',     section: 'Pages', icon: 'folder',  status: 'live' },
