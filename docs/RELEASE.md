...
### A raw control byte makes a tracked file unreviewable, and nothing checks (2026-09-15) · FIXED — awaiting merge (#PRNUM)
...
**What shipped (DREAMCRM-66, #PRNUM).** `tests/guards/control-bytes.ts` +
