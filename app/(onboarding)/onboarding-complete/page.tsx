            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                <div className="text-center">
                  ...
                  <h1 className="text-3xl text-gray-800 dark:text-gray-100 font-bold mb-3">You're all set 🙌</h1>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">
                    Payment confirmed. Your clinic is ready to go — head to your dashboard to finish setting things up.
                  </p>
                  <button
