      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            These details power your public clinic website and identify your clinic across Dream Create.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-3">
                <input id="brandColor" name="brandColor" className="form-input w-24" type="text" placeholder="#8b5cf6" defaultValue={profile?.brandColor ?? ''} />
