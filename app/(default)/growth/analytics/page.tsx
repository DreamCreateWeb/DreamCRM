      ...
      <PageHeader
        ...
        actions={
          ...
          <div className="flex items-center gap-1.5">
            {[30, 90].map((d) => (
              <FilterChip key={d} href={`/growth/analytics?days=${d}`} active={windowDays === d}>
                {d} days
              </FilterChip>
            ))}
          </div>
      ...
      >
        {social.connected ? (
          ...
          <div className="mt-3 text-right">
            <Link href="/growth/social" className="text-xs font-medium text-teal-700 dark:text-teal-400 hover:underline">
