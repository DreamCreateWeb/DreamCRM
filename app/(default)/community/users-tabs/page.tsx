...
import TabCard, { type TabUser } from '../tab-card'
...
export const metadata = {
  ...
  description: 'Member directory (tab cards)',
}

export const dynamic = 'force-dynamic'

export default async function UsersTabs() {
  await requireUser()
  const users = await listCommunityUsers()
  const tabs: TabUser[] = users.map((u) => ({
    id: u.id,
    name: u.name,
    email: u.email,
    image: u.image,
