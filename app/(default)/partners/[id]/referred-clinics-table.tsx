...
import { formatTerm, moneyFromCents } from '@/lib/types/referrals'
...
/**
 * Per-clinic referral rows with an inline-editable % override + term. Editing a
 * row updates just that clinic's `referral_percent_bps`/`referral_term_months`
 * — the partner default + the term clock are untouched.
 */
export default function ReferredClinicsTable({ partnerId, clinics }: { partnerId: string; clinics: ClinicRow[] }) {
