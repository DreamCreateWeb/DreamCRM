        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Recall and win-back campaigns aim at this hour, in each clinic&rsquo;s own time
              zone. Reminders and review asks keep their own timing &mdash; they are tied to an
              appointment, not to a good moment to read email. Patterns only &mdash; no patient
              data leaves a practice.
            </p>
