  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-4">
        ...
        <div>
          <h3 className="text-base font-semibold text-gray-800 dark:text-gray-100">Connect Open Dental</h3>
      ...
      <ol className="text-sm text-gray-600 dark:text-gray-300 space-y-1.5 mb-4 list-decimal pl-4">
        <li>
          In Open Dental, go to <span className="font-medium">Setup → Advanced → API</span> and generate a Customer Key.
        </li>
