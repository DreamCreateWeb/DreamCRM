...
export default function SavedViewsBar({
  ...
  /** tagId → name, for the chip descriptions. */
  ...
  const tagMap = new Map(Object.entries(tagNames))
  ...
  return (
    <div className="mb-3 flex flex-wrap items-center gap-1.5">
      ...
      {/* Promote the current segment into a sendable audience (premium) */}
      {canMarket && !empty && (
        <button
          type="button"
          onClick={promote}
          ...
          className="ml-auto rounded-full px-2.5 py-1 text-xs font-medium text-violet-700 ring-1 ring-inset ring-violet-400/50 hover:bg-violet-500/10 dark:text-violet-300"
        >
          ✦ Send a campaign to these
        </button>
      )}
