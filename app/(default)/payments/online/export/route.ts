...
/**
 * Download the clinic's collected online balance payments as a CSV.
...
export async function GET() {
  ...
  const csv = await exportBalancePaymentsCsv(ctx.organizationId)
  ...
  return new NextResponse(csv, {
    ...
    headers: {
      ...
      'Content-Disposition': `attachment; filename="${slug}-payments-${stamp}.csv"`,
