...
// Postgres error codes we silently skip mid-migration: relation already
// exists, column already exists, duplicate object. Lets a partially-applied
// migration finish without manual surgery.
