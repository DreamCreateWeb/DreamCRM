...
const BORDER = '#E8E2D9'
const FIELD =
  'w-full text-[15px] px-3.5 py-2.5 rounded-xl border bg-white focus:outline-none focus:ring-2 focus:ring-offset-0'
  ...
  return (
    ...
    >
      ...
      <div className="grid sm:grid-cols-2 gap-3.5">
        <input name="name" required placeholder="Full name *" className={FIELD} style={{ borderColor: BORDER }} />
        <input name="email" type="email" required placeholder="Email *" className={FIELD} style={{ borderColor: BORDER }} />
      </div>
      <div className="grid sm:grid-cols-2 gap-3.5">
        <input name="phone" placeholder="Phone" className={FIELD} style={{ borderColor: BORDER }} />
        <input name="linkedinUrl" type="url" placeholder="LinkedIn (optional)" className={FIELD} style={{ borderColor: BORDER }} />
      </div>
      <textarea
        name="coverNote"
        rows={4}
